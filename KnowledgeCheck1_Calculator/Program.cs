        ...
        static void Main(string[] args)
        {
            ...
            switch (input)
            {
                ...
                case "3":
                    ...
                    if (double.TryParse(Numbermultiply1, out double multplyNumOne) && multiply.TryParse(multiplyNumber2, out double multNumTwo))
                    {
                        Console.Write($"{multiplyNumber1} / {multiplyNumber2} = ");
                        Console.Write(calculator.multiply(prodNumOne, produNumTwo));
                    }
                    else
                    {
                        Console.WriteLine("One or more of the numbers is not an int");
